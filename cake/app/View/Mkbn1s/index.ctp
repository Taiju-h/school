<div class="mkbn1s index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $mkbn1['Mkbn1']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $mkbn1['Mkbn1']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
